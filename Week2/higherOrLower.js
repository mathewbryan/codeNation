...
const higherOrLower = () => {
if (newCard[0] > currentCard[0] && userInput == 1 || newCard > currentCard && userInput.toLowerCase() == 'higher'){
...
else if (newCard[0] < currentCard[0] && userInput == 2 || newCard < currentCard && userInput.toLowerCase() == 'lower'){
